...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "HTTPService"))
...
def wiki_list_topics(instance: str, layer: str = "minified") -> list[str]:
    """List all topic names in a layer (raw/documentation/llm/minified/changelog/devlog)
