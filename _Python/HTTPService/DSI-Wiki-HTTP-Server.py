...
def _load_module(name, path):
    """MCPService/UIService filenames use hyphens, so a plain `import` can't
...
def build_app():
    ...
    mcp_module = _load_module("dsi_wiki_mcp_server", os.path.join(repo_python_dir, "MCPService", "DSI-Wiki-MCP-Server.py"))
    ui_module = _load_module("dsi_wiki_ui_server", os.path.join(repo_python_dir, "UIService", "DSI-Wiki-UI-Server.py"))
